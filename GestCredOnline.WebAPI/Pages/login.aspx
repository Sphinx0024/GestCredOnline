<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GestCredOnline.WebAPI.Pages.login" %>
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form action="#">
			...
			<button id="BtnConnexion" type="button">Connexion</button>
				<a id="BtnSimulation" href="#" type="button">Faire une simulation</a></form>
	</div>
    ...
    <script type="text/javascript">	
		...
		const simulButton = document.getElementById('simul');
		...
		BtnSimulation.addEventListener('click', () => {
            ...
            localStorage.setItem(appConfig.connectToken, 'prospect');
            localStorage.setItem(appConfig.connectTokenType, 'prospect');
            localStorage.setItem(appConfig.profileName, 'prospect');
            localStorage.setItem(appConfig.connectConnected, 'prospect');

            localStorage.setItem('racine', 'prospect');
            location.href = 'simul_prospect.aspx';
		});

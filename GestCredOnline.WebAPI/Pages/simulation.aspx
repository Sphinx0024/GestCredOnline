<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Contenu.master" AutoEventWireup="true" CodeBehind="simulation.aspx.cs" Inherits="GestCredOnline.WebAPI.Pages.simulation" %>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-sx-12">
                                    <div class="form-group">
                                        <br />  
                                        <button id="Btn_Save_Request1" type="button" style="border: 1px solid #00ff21" class="btn btn-success pull-right btn-lg">Enregistrer la simulation</button> 

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Contenu.master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="GestCredOnline.WebAPI.Pages.index" %>
            ...
            <div class="widget-box transparent">
                <div class="widget-header widget-header-flat">
                    <h4 class="widget-title lighter">
                        ...
                        Demandes en attente de soumission
                    </h4>
    ...
    <script type="text/javascript">    
        ...
        dahshboard.InitializePage = function () {
            ...
            dahshboard.count(function () {
                ...
                dahshboard.designBottom(appConfig.Status.EnAttente, 'infobox-orange2', 'Demandes en attente de soumission', function () {

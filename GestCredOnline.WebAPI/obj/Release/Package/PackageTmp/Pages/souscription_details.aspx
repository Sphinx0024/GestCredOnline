<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Contenu.master" AutoEventWireup="true" CodeBehind="souscription_details.aspx.cs" Inherits="GestCredOnline.WebAPI.Pages.souscription_details" %>
    ...
    <div class="page-body" id="DivShowContent">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                     <div id="DivMessageAlert" class="alert alert-warning">
                ...
                <br>
                 ...
                 <div id="DivMessageDisqualification" style="display: none;" class="btn btn-danger "> 
                                    
                     Nous sommes désolé. <br />
                     il semble que vous ne remplissez pas toutes les conditions pour l'octroi de ce crédit. <br>
                     Veuillez vous rendre en agence pour obtenir plus d'informations
                                </div>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-6"  style="border-right: 1px solid #34a839;">
                                <div id="DivDetails"></div>


                                 <div class="sub-title font-weight-bold" style="margin-bottom:5px">Actions sur la demande</div>
                                  
                                 <div id="DivInformationDocument" class="btn btn-danger DivInformationDocument"> 
                                     L'ajout de la documentation est requis pour l'envoi de la demande. Rendez vous à la section <b>DOCUMENTS</b> 
                                </div>
                                 ...
                                 <button id="BtnModifier" class="btn btnaction btn-white btn-warning btn-bold">
                                        <i class="ace-icon fa fa-pencil bigger-120 warning"></i>
                                        Modifier 
                                    </button>
                                ...
                                <button id="BtnSimulation" class="btn btnaction btn-white btn-primary btn-bold">
                                        <i class="ace-icon fa fa-credit-card  bigger-120 blue"></i> 
                                       Consulter la simulation 
                                    </button>

                            </div>
                          
                            <div class="col-lg-12 col-xl-3" style="border-right: 1px solid #34a839;"> 
                                  <div class="sub-title font-weight-bold">Niveau de risque</div>
                                <div id="DivCommentaire"></div>
                            </div>
                            <div class="col-lg-12 col-xl-3">
                               
                                <div class="sub-title">Documents</div>
                                 <div id="DivInformationDocument1" class="btn btn-success DivInformationDocument"> 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFoot" runat="server">
    ...
    <script type="text/javascript">    
        ...
        show_request.InitControle = function () {
            ...
            $('#BtnSimulation').off().on('click', function () {

                

              let csnl =   appHelper.calculSimulation(
                    show_request.simulationParam.Depart,
                    show_request.simulationParam.Periodicite,
                    show_request.simulationParam.Duree,
                    show_request.simulationParam.Taux,
                  show_request.simulationParam.Montant);
        ...
        show_request.statuss = function (status) {
           // show_request.status = status;
            switch (status) {
                ...
                case appConfig.Status.EnAttente: $('#BtnAnnuler').removeAttr('disabled'); return 'Votre demande est en attente de soumission';
        ...
        show_request.show = function (ID) {
            helper.Odata.get("Request(" + ID + ")?$expand=Client,Fichier($expand=ProductProgramCheckList),ProductProgram($expand=ProductProgramCheckList)",
                "#DivShowContent", "#DivShowContent", null, null, function (data) {
                    ...
                    show_request.simulationParam = {
                        Depart: helper.ToLocalDateString(data.DemandeDate),
                        Taux: data.CreditTaux,
                        Duree: data.CreditDuree,
                        Periodicite: data.CreditPeriodicite,
                        Montant: data.CreditMontant
                    };
        ...
        show_request.file_list = function (checklist, files) {
            ...
            if (show_request.status == 4) {
                $('#DivMessageDisqualification').show();
                $('#DivMessageAlert').hide();
            }

            if (v === false && show_request.status === appConfig.Status.EnAttente) {
                $('#BtnEnvoyer').removeAttr('disabled');
                $('#BtnModifier').removeAttr('disabled');
                $('#BtnSimulation').removeAttr('disabled');
                $('.DivInformationDocument'). hide();

            } else {
                $('.DivInformationDocument').show();
                $('#BtnEnvoyer').attr('disabled', 'disabled');
                $('#BtnModifier').attr('disabled', 'disabled');
                $('#BtnModifier').removeAttr('disabled');
                $('#BtnSimulation').removeAttr('disabled'); 
            }
            if (show_request.status == 4) {
    ...
    <script id="TmplShowDetails" type="text/template">
          ...
          <div class="sub-title font-weight-bold">Contrat</div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-900">Durée du prêt</p>
